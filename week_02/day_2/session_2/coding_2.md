...
1. Inherited
```
color font-size text-align font-weight word-wrap visibility
```
2. Non-Inherited
```
padding margin background-color border display float height width overflow z-index position overflow clear
```
