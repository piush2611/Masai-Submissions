...
export class Mark extends Component {
    ...
    handleClick = () => {
        ...
        axios.post("http://127.0.0.1:5000/purchased", data)
            .then(res => {
                alert(res.data);
                ...
                <div className='container'>
                    {
                        ...
                        <div className="bg-light w-50 p-3 text-center m-5">
                            <h3 className="text-dark mb-2">Are you sure you want to buy it ?</h3>
                        ...
                        <table className="table table-responsive m-5">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><button className="btn btn-danger" onClick={this.handleShow}>Purchase</button></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
